...
<div class="py-6 sm:py-10">
  <div class="max-w-6xl mx-auto backdrop-blur-md bg-white/80 rounded-xl shadow-2xl p-4 sm:p-8 border border-white/30">
    <h1 class="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-center text-gray-900 drop-shadow-lg">Top Rated Actors</h1>
    <p class="text-center text-gray-700 mb-4 sm:mb-6 text-sm sm:text-base">Actors ranked by adjusted average rating using Bayesian shrinkage</p>
        ...
        <div class="bg-white/90 rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow duration-200">
          <div class="flex justify-between items-start mb-3">
            <div class="flex-1">
              <div class="flex items-center gap-2 mb-1">
                ...
                <a href="{base}/person/{actor.tmdb_id}" class="text-blue-700 hover:text-blue-900 font-semibold text-lg leading-tight">
                  {actor.name}
                </a>
              </div>
            </div>
          ...
          <div class="grid grid-cols-2 gap-3 text-sm text-gray-600 mb-3">
            <div class="flex items-center">
              ...
              <CompactRating rating={actor.raw_avg_rating} size="xs" color="blue" />
            </div>
            <div class="flex items-center">
            ...
            <div class="flex items-center">
              ...
              <span class="ml-1 text-xs">{actor.min_rating}-{actor.max_rating}</span>
            </div>
            <div class="flex items-center">
              <span class="font-medium text-gray-700">Shrinkage:</span>
              <span class="ml-1 text-xs">{actor.shrinkage_factor}</span>
            </div>
          </div>
